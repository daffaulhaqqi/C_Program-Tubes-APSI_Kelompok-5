...
@section('content')
    <main class="p-6">
        <div class="grid lg gap-6 mt-1">
            <a href="/admin/competition/create" style="width: 20%" class="btn bg-info text-white py-2 px-3">Add
                Competition</a>

            <div class="card bg-white overflow-hidden">
                <div class="card-header flex justify-between">
                    <h4 class="card-title">Competition Table</h4>
                    <a href="{{ route('competition.deletelist') }}" class="btn bg-dark text-white text-xs">View Deleted List</a>
                </div>
                <div>
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody>
                                        @foreach ($competitions as $competition)
                                                        ...
                                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 bg-white shadow py-2 z-10 hidden"
                                                            ...
                                                            @if ($competition->status == 'upcoming')
                                                                <a class="flex items-center gap-x-3.5 py-2 px-3 text-sm text-gray-800 hover:bg-gray-100"
                                                                    href="{{ route('competition.detail', $competition->id) }}">
                                                                    Detail
                                                                </a>
                                                                <hr class="my-2 border-gray-200">

                                                                <a href="{{ route('competition.toregistration', $competition->id) }}"
                                                            ...
                                                            @else
                                                                ...
                                                                @if ($competition->competition_participants->isNotEmpty())
                                                                    @if ($competition->winners->isEmpty())
                                                                        <a class="flex items-center gap-x-3.5 py-2 px-3 text-sm text-gray-800 hover:bg-gray-100"
                                                                            href="javascript:;"
                                                                            data-hs-overlay="#hs-slide-up-animation-modal1{{ $competition->id }}">
                                                                            Select Winner
                                                                        </a>
                                                                    @else
                                                                        <a class="flex items-center gap-x-3.5 py-2 px-3 text-sm text-gray-800 hover:bg-gray-100"
                                                                        href="javascript:;"
                                                                        data-hs-overlay="#hs-slide-up-animation-modal2{{ $competition->id }}">
                                                                        Edit Winner
                                                                        </a>
                                                                    @endif
                                                                @endif
                                            ...
                                            {{-- Select Winner Modal --}}
                                            <div id="hs-slide-up-animation-modal1{{ $competition->id }}"
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex flex-col bg-white border shadow-sm rounded-xl">
                                                        ...
                                                        <form
                                                            action="{{ route('competition.selectwinner', $competition->id) }}"
                                            ...
                                            {{-- View Winner Modal --}}
                                            <div id="hs-slide-up-animation-modal{{ $competition->id }}"
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex flex-col bg-white border shadow-sm rounded-xl">
                                                        <div class="flex justify-between items-center py-3 px-4 border-b">
                                                            ...
                                                            <button type="button"
                                                                class="hs-dropup-toggle inline-flex flex-shrink-0 justify-center items-center h-8 w-8 rounded-md text-gray-500 hover:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white transition-all text-sm"
                                                                data-hs-overlay="#hs-slide-up-animation-modal{{ $competition->id }}">
                                                                <span class="sr-only">Close</span>
                                                                <svg class="w-3.5 h-3.5" width="8" height="8"
                                                                    viewBox="0 0 8 8" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                ...
                                                                @foreach ($winner as $w)
                                                                    <div class="card">
                                                                        <div class="p-5 flex items-center justify-between">
                                                                            <span>
                                                                                <span
                                                                                    class="text-slate-400 font-semibold block">Position
                                                                                    {{ $w->position }}</span>
                                                                                <span
                                                                                    class="text-xl font-semibold"><span>{{ $w->competition_participants->fullname }}</span></span>
                                                                            </span>
                                            ...
                                            {{-- Edit Winner Modal --}}
                                            <div id="hs-slide-up-animation-modal2{{ $competition->id }}"
                                                class="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto">
                                                <div
                                                    class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-14 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                                                    <div class="flex flex-col bg-white border shadow-sm rounded-xl">
                                                        ...
                                                        <form
                                                            action="{{ route('competition.editwinner', $competition->id) }}"
                                                            method="post" enctype="multipart/form-data">
                                                            @csrf
                                                            <div
                                                                class="flex justify-between items-center py-3 px-4 border-b">
