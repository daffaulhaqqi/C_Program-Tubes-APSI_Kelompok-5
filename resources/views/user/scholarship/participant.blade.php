...
<body>
  ...
  <section id="scholar-winners" class="mb-14 flex justify-center w-full">
    <div class="container" data-aos="fade-down">
      <div class="flex flex-col text-center items-center justify-center px-24 py-16">
        <p class="font-semibold text-5xl">Awardees</p>
      ...
      <div class="flex flex-row flex-wrap items-center justify-center text-center">
        ...
        {{-- perulangan --}}
        <div class="cardview-5 bg-[#fef3b8] flex flex-col text-center justify-center items-center mx-5 rounded-2xl border border-gray-400 mb-8">
          <p>{{ $awardee->scholarship_participants->fullname }}</p>
          <p>{{ $awardee->scholarship_participants->nim }}</p>
        </div>
        @endforeach
  ...
  @if($scholarshipParticipants->isNotEmpty())
  <section id="scholar-participants" class="flex justify-center w-full">
    <div class="container" data-aos="fade-up">
      ...
      <div class="flex flex-row flex-wrap items-center justify-center text-center">
        @foreach ($scholarshipParticipants as $cp)
        {{-- perulangan --}}
